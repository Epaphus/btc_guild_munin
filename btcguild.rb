...
parsed["workers"].each do |worker|
  ...
  puts "#{worker[count]["worker_name"]}_validshare.type GAUGE"
  ...
  puts "#{worker[count]["worker_name"]}_staleshare.type GAUGE"
  ...
  puts "#{worker[count]["worker_name"]}_dupeshare.type GAUGE"
  ...
  puts "#{worker[count]["worker_name"]}_unknownshare.type GAUGE"
